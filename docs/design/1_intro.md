...
An e3 *wrapper* is a separate (from the source EPICS module) repository containing site-specific modifications and additions: configuration files, source code modifications in the form of patches, and essentially an API to the module through what we call *snippets*.
