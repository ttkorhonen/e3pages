...
libcurl-devel gsl-devel  git gobject-introspection-devel \
xorg-x11-proto-devel libX11-devel libXext-devel bzip2-devel \
freetype-devel lcms2-devel ethercat-generic-dkms-1.5.2.ESS1-1
```
